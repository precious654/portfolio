...
const Navbar = () => {
    ...
    () => {
      ...
      const timeline = gsap.timeline({
        scrollTrigger: {
          ...
          end: "50% top", // End when middle of page reaches top of viewport
  ...
  return (
    <header 
      ref={navRef}
      className="w-full py-10 flex justify-center items-center fixed top-0 left-0 z-50"
    >
      <nav className="flex items-center justify-between lg:w-5/12 p-4 rounded-lg bg-background/20 backdrop-blur-lg">
        <Link href="/">
          Home
        </Link>
        <Link href="/">
